...
sudo apt-get update
sudo apt-get install apache2 php5 libapache2-mod-php5 libapache2-mod-perl2 php5 php5-cli php5-common php5-curl php5-dev php5-gd php5-imap php5-ldap php5-mhash php5-mysql php5-odbc php-pear php-apc git
...
echo "Now wiringPi will be installed. If fails, please install manual!"
cd
